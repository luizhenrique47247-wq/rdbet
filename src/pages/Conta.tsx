...
export const Conta: React.FC = () => {
  ...
  return (
    <div className="space-y-4 text-center select-none pb-2 animate-fade-in max-w-md mx-auto flex flex-col justify-center">
      {/* Premium Avatar Layout (Circular green orbit + intersecting rotating dot) - Original Size restored */}
      ...
      {/* Buttons stack - Stacked vertically as original */}
